...
<html>
    <head>
        <meta charset="UTF-8">
        <title>ADMIN _ CV RAJAWALI</title>
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="font-weight: bold;" href="?page=utama">CV RAJAWALI CT</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <?php if(isset($_SESSION['level']) && $_SESSION['level']==1) { ?>
                <li><a href="?page=penumpang&actions=tampil">Data Penumpang</a></li>
                <li><a href="?page=penumpang&actions=report">Laporan</a></li>
                <?php } ?>
...
?>
    ...
    <div class="row">
        <div class="col-xs-12">
            Copyright &COPY; <?= date('Y')?> Ratna Sari |
